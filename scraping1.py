...
thingie = ["A","B","C","D","E","F","G","H","J","K","L","M","N","X","Y","S","P","V"]#blocks of student roll numbers
test=[]
test1=[]
for alphabet in thingie:
    link = "http://www.neduet.edu.pk/admission/2017/19-08-2017/RESULT_2017_18/sheets/BLOCK%20{}.htm".format(alphabet) #making links for each block
    ...
    print("{}:{}".format(alphabet,result)) #printing each block and its list of failed students because it looks cool in the terminal
